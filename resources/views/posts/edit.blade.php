...
@section('content')
    ...
    <form method="post" action="{{ route('posts.update', [$post->slug]) }}">
        ...
        <div class="field">
            ...
            <div class="control">
                <input type="text" name="title" value="{{ $post->title }}" class="input" placeholder="Title" minlength="5"
        ...
        <div class="field">
            ...
            <div class="control">
                <textarea name="content" class="textarea" placeholder="Content" minlength="5" maxlength="2000" required
            ...
            <div class="control">
                <div class="select">
                    <select name="category" required>
                        ...
                        <option value="javascript" {{ $post->category === 'javascript' ? 'selected' : null }}>JavaScript
                        </option>
